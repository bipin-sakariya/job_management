                    ...
                    renderItem={({ item, index }) => (
                        <View style={{ paddingHorizontal: wp(4), ...globalStyles.rowView, marginBottom: wp(4) }}>
                            ...
                            <View style={{ flex: 1, ...globalStyles.rowView, justifyContent: 'space-between' }}>
                                <View>
                                    <Text style={[globalStyles.rtlStyle, { fontFamily: fonts.FONT_POP_MEDIUM, fontSize: FontSizes.SEMI_LARGE_20, paddingHorizontal: wp(2.5) }]}>{item.title}</Text>
                                    <Text style={[globalStyles.rtlStyle, { fontFamily: fonts.FONT_POP_REGULAR, fontSize: FontSizes.EXTRA_SMALL_12, paddingHorizontal: wp(2.5) }]}>{item.description}</Text>
                                </View>
